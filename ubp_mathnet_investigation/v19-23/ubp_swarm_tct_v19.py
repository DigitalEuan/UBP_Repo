...
# ── UBP Core imports ──────────────────────────────────────────────────────────
# Change to core dir so MoE and other modules can find their KB files via
# relative paths (the module uses 'ubp_system_kb.json' without a path prefix)
_ORIG_DIR = Path.cwd()
...
class UBPSwarmTCTv19:
    ...
    def __init__(self):
        ...
        self.harvester  = OntologicalHarvester(
            _SCRIPT_DIR / "results" / "ubp_learned_kb.json"
        )
