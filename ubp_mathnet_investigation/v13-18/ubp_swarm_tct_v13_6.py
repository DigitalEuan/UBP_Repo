...
"""
================================================================================
UBP SWARM ORCHESTRATOR — TCT EDITION v13.6 "THE COMPLETE CONSTANT"
================================================================================
Author: UBP Research Cortex v5.0
Date: 27 April 2026

FIXES:
- Global: Restored missing _golay_snap and _nrci_of helper functions.
...
log = logging.getLogger("UBP_TCT_v13_6")
...
class UBPSwarmTCTv13_6:
    ...
    def run(self, problem_file: str):
        ...
        report = "# UBP TCT v13.6 — THE COMPLETE CONSTANT REPORT\n\n"
        for p in problems:
