...
_DIRECTIVE_RE_DERIV = re.compile(
...
class UBPSwarmTCTv7:
    def __init__(self, training_steps: int = 250_000, seed: int = 24,
        ...
        self.vm = UBPPyVM(kb_path="ubp_system_kb.json",
                          lattice_path="results/v7_lattice.json")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--output-md", default="results/v7_run.md")
    p.add_argument("--output-json", default="results/v7_run.json")
    return p
