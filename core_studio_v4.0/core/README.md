...
- Workspace purified — twelve legacy scripts moved to `archive_core/`.
- `ubp_analog_test_suite_v3.py` → `ubp_electromagnetic_analog_compute_engine.py`; `bp_genesis_boot.py` → `ubp_genesis_boot.py`.
