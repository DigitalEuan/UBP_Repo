"""
GLM Language Database — Priority Vocabulary v2.0
================================================
Grounded entries related to mathematical and substrate concepts.
Expanded with Tier 5 (Logic/Meta) and Tier 6 (Physics) grounded extensions.
"""
...
if __name__ == "__main__":
    ...
    for lemma in ["proton", "interacts", "electron"]:
        w = LANG_DB.get(lemma)
        if w:
