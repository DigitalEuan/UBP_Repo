...
\fancyfoot[L]{\small\color{gray} Generated using K-Dense Web (\href{https://k-dense.ai}{k-dense.ai})}
\fancyfoot[C]{\small\thepage}
\fancyfoot[R]{\small\color{gray} UBP-NZF-2026-V2}
...
\begin{center}
\includegraphics[width=0.92\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/graphical_abstract.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig7_mathatlas_flowchart.png}
  \caption{UBP MathAtlas Computational Pipeline Flowchart. The full pipeline from raw
  molecular formula through elemental NRCI lookup, bond correction, topology compactness
  adjustment, and Hamming Lattice Distance calculation to the final NRCI$_{v6}$ and
  Fuel Quality Index (FQI) output. Each stage corresponds to a discrete SOP\_002
  protocol step within UBP Core Studio v4.0.}
  \label{fig:mathatlas_flow}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig1_system_health_dashboard.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig3_molecular_atlas.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig2_vapor_combustion_analysis.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig8_intervention_diagram.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig4_intervention_strategy.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig5_leech_lattice_map.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{/app/sandbox/session_20260401_122838_1d6509467bbc/figures/fig6_summary_infographic.png}
...
\textbf{END OF PAPER: UBP-NZF-2026-V2}\\[6pt]
\rule{0.5\linewidth}{0.3pt}\\[4pt]
Generated using K-Dense Web (\href{https://k-dense.ai}{k-dense.ai})
\end{center}
