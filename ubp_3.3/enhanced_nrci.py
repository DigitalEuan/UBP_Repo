"""
Universal Binary Principle (UBP) Framework v3.3 - Enhanced Non-Random Coherence Index (NRCI) for UBP
Author: Euan Craig, New Zealand
Date: 31 October 2025 (Updated for UBP 3.3)
Previous: 03 September 2025 (UBP 3.2)
==================================
...
- OnBit Regime: NRCI ≥ 0.999997 (updated for UBP 3.3)
...
class CoherenceRegime(Enum):
    ...
    ONBIT = "OnBit"              # NRCI ≥ 0.999997 (UBP 3.3)
...
class NRCIConfig:
    ...
    onbit_threshold: float = 0.999997  # OnBit regime threshold (UBP 3.3)
