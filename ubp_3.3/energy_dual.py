"""
Universal Binary Principle (UBP) Framework v3.3 - Dual-Mode Energy System
Author: Euan Craig, New Zealand
Date: 31 October 2025
================================================================================

This module implements dual-mode energy calculations:
1. SOC Mode (UBP 3.3): Simplified Observer Coherence equation
2. Legacy Mode (UBP 3.2): Full energy equation with explicit factors

The SOC mode is the primary calculation method for UBP 3.3, representing
...
class EnergyMode:
    ...
    SOC = "soc"          # Simplified Observer Coherence (UBP 3.3)
...
if __name__ == "__main__":
    ...
    print("SOC mode (UBP 3.3) is the primary calculation method.")
